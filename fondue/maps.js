...
var vector = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: 'https://www.xavieralexandre.org/fondue/routes/capites.kml',
...
var vector = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: 'https://www.xavieralexandre.org/fondue/routes/rivaz.kml',
    format : new ol.format.KML({
      projection: 'EPSG:21781'
    }),
    extractStyles: true
...
var vector = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: 'https://www.xavieralexandre.org/fondue/routes/riex.kml',
    format : new ol.format.KML({
      projection: 'EPSG:21781'
    }),
    extractStyles: true
...
var vector = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: 'https://www.xavieralexandre.org/fondue/routes/chatelard.kml',
    format : new ol.format.KML({
      projection: 'EPSG:21781'
    }),
    extractStyles: true
...
var vector = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: 'https://www.xavieralexandre.org/fondue/routes/aran.kml',
    format : new ol.format.KML({
      projection: 'EPSG:21781'
    }),
    extractStyles: true
